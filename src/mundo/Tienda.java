...
public class Tienda {
    ...
    public int venderProducto(String pNombreProducto, int pCantidad) {
        ...
        if (darProducto(pNombreProducto) != null) {
            darProducto(pNombreProducto).vender(pCantidad);
            dineroEnCaja = pCantidad * darProducto(pNombreProducto).calcularPrecioFinal();
    ...
    public boolean abastecerProducto(String pNombreProducto, int pCantidad) {
        ...
        if (darProducto(pNombreProducto) != null) {
            System.out.println("pNombreProducto");
            if (darProducto(pNombreProducto).puedeAbastecer()){
     ...
     */
    public boolean cambiarProducto(String pNombreActual, String pNombreNuevo, String pTipo,
                                   double pValorUnitario, int pCantidadBodega, int pCantidadMinima,
                                   String pRutaImagen) {
        boolean cambio = false;

        // Verificar si ya existe un producto con el nombre nuevo
        while (darProducto(pNombreActual) != null) {
            String productoSelect = String.valueOf(darProducto(pNombreActual));

            if (!productoSelect.equals(pNombreNuevo)){
